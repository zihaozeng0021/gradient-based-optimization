...
# ---------------------------
file_pattern = "data/part2/training_stats_*.dat"
...
plt.title("Training Accuracy vs Iterations (Part 2)")
plt.grid(True)
plt.legend(loc='best')
plt.tight_layout()
plt.savefig("data/part2/accuracy_training_plot.png")
plt.close()
...
plt.ylabel("Test Accuracy")
plt.ylim(0.85, 1)
plt.title("Test Accuracy (Iterations > 30000) (Part 2)")
plt.grid(True)
plt.legend(loc='best')
plt.tight_layout()
plt.savefig("data/part2/accuracy_after30000.png")
plt.close()
